...
public class CinemasContentProvider extends ContentProvider {
    ...
    private static final String TAG = CinemasContentProvider.class.getName();
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(FilmasiaContract.AUTHORITY2, FilmasiaContract.PATH_PLACES, PLACES);
        uriMatcher.addURI(FilmasiaContract.AUTHORITY2, FilmasiaContract.PATH_PLACES + "/#", PLACE_WITH_ID);
        return uriMatcher;
    }

    // Member variable for a PlaceDbHelper that's initialized in the onCreate() method
    private FilmasiaDBHelper dbHelper;
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case PLACES:
                ...
                long id = db.insert(FilmasiaContract.PlaceEntry.TABLE_NAME, null, values);
                if (id > 0) {
                    returnUri = ContentUris.withAppendedId(FilmasiaContract.PlaceEntry.CONTENT_URI, id);
                } else {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case PLACES:
                retCursor = db.query(FilmasiaContract.PlaceEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case PLACE_WITH_ID:
                ...
                placesDeleted = db.delete(FilmasiaContract.PlaceEntry.TABLE_NAME, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            case PLACE_WITH_ID:
                ...
                String id = uri.getPathSegments().get(1);
                // Use selections/selectionArgs to filter for this ID
                placesUpdated = db.update(FilmasiaContract.PlaceEntry.TABLE_NAME, values, "_id=?", new String[]{id});
                break;
            // Default exception
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
